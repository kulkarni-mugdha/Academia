...
export const dummyTestimonial = [
    {
        name: 'Aarav Sharma',
        role: 'B.Tech Student, Jaipur',
        image: assets.profile_img_1,
        rating: 5,
        feedback: 'The lessons were easy to follow and helped me build confidence for my college projects. I could finally understand concepts that used to feel intimidating.',
    },
    {
        name: 'Priya Mehta',
        ...
        rating: 4,
        feedback: 'I wanted to switch into tech while working full-time, and these courses gave me a practical path. The examples felt relevant and the pacing suited my schedule.',
    },
    {
        name: 'Rohan Patil',
        ...
        rating: 4.5,
        feedback: 'The course structure made revision before placements much easier. I especially liked the hands-on approach and the way each topic connected to real use cases.',
    },
    {
        name: 'Neha Verma',
        ...
        image: assets.profile_img_2,
        rating: 5,
        feedback: 'The platform felt beginner-friendly from day one. I was able to practice consistently and apply what I learned in assignments and internship tasks.',
    },
];

...
const CourseDetails = () => {
  ...
  const { backendUrl, userData, calculateChapterTime, calculateCourseDuration, calculateRating, calculateNoOfLectures, calculateDiscountedPrice, formatPrice } = useContext(AppContext)
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-4xl text-2xl font-semibold">{formatPrice(calculateDiscountedPrice(courseData.coursePrice, courseData.discount))}</p>
